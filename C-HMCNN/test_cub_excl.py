...
def main():
    ...
    checkpoint_model = torch.load("models/model_d_with_constraints_exclusivity/250430_model-d_model.pth")
    checkpoint_gate = torch.load("models/model_d_with_constraints_exclusivity/250430_model-d_gate.pth")
    if pretrained == True:
